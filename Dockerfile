...
RUN unzip riot-db-2.16.0.zip && \
    rm riot-db-2.16.0.zip && \
    chmod +x riot-db-2.16.0/bin/riot-db


ENV PATH="${PATH}:/riot-db-2.16.0/bin"

ENTRYPOINT ["/riot-db-2.16.0/bin/riot-db"]
