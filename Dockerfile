...
RUN unzip riot-file-2.16.1.zip && \
    rm riot-file-2.16.1.zip && \
    chmod +x riot-file-2.16.1/bin/riot-file


ENV PATH="${PATH}:/riot-file-2.16.1/bin"

ENTRYPOINT ["/riot-file-2.16.1/bin/riot-file"]
