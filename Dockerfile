...
RUN unzip riot-db-2.16.1.zip && \
    rm riot-db-2.16.1.zip && \
    chmod +x riot-db-2.16.1/bin/riot-db


ENV PATH="${PATH}:/riot-db-2.16.1/bin"

ENTRYPOINT ["/riot-db-2.16.1/bin/riot-db"]
