...
RUN unzip riot-gen-2.15.4.zip && \
    rm riot-gen-2.15.4.zip && \
    chmod +x riot-gen-2.15.4/bin/riot-gen


ENV PATH="${PATH}:/riot-gen-2.15.4/bin"

ENTRYPOINT ["/riot-gen-2.15.4/bin/riot-gen"]
