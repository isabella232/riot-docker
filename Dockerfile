...
RUN unzip riot-file-2.15.2.zip && \
    rm riot-file-2.15.2.zip && \
    chmod +x riot-file-2.15.2/bin/riot-file


ENV PATH="${PATH}:/riot-file-2.15.2/bin"

ENTRYPOINT ["/riot-file-2.15.2/bin/riot-file"]
