...
RUN unzip riot-gen-2.16.1.zip && \
    rm riot-gen-2.16.1.zip && \
    chmod +x riot-gen-2.16.1/bin/riot-gen


ENV PATH="${PATH}:/riot-gen-2.16.1/bin"

ENTRYPOINT ["/riot-gen-2.16.1/bin/riot-gen"]
