...
RUN unzip riot-gen-2.15.5.zip && \
    rm riot-gen-2.15.5.zip && \
    chmod +x riot-gen-2.15.5/bin/riot-gen


ENV PATH="${PATH}:/riot-gen-2.15.5/bin"

ENTRYPOINT ["/riot-gen-2.15.5/bin/riot-gen"]
